...
public interface DataSource {
  ...
  /**
   * Each {@link com.plavaga.document.duke.DataSource} is responsible of writing
   * its XML configuration using provided {@link com.plavaga.document.duke.ConfigWriter}
   * instance.
