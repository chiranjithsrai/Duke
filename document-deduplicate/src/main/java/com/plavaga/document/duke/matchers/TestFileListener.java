...
import com.plavaga.document.duke.Database;
...
import com.plavaga.document.duke.LinkStatus;
...
public class TestFileListener extends AbstractMatchListener {
  ...
  public synchronized Set<Object> matches(Record r1, Record r2, double confidence) {
    String id1 = getid(r1);
    String id2 = getid(r2);
